# Olá! Eu sou a Lara Scaranello 👩‍💻✨

Desenvolvedora **Full Stack** apaixonada por tecnologia e pela criação de soluções através do código.

Tenho experiência no desenvolvimento de **aplicações web e mobile**, atuando tanto no **front-end quanto no back-end**, além da construção de **APIs REST**, integração com **bancos de dados** e desenvolvimento de **aplicativos mobile com Flutter**.
...
![CSS](https://img.shields.io/badge/CSS-007ACC?logo=css3&logoColor=white)
...
![IoT](https://img.shields.io/badge/IoT-f72585?logo=internetofthings&logoColor=white)
...
<a href="mailto:laraselena0911@gmail.com">
